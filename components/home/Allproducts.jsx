    ...
    <div>
      ...
      <div className="w-full flex">
        <div class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 px-4">
          <a href="#">
            <img class="rounded-t-lg" src="../assets/n4.jpg" alt="" />
          </a>
          <div class="p-5">
            <a href="#">
        ...
        <div class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 px-4">
          <a href="#">
            <img class="rounded-t-lg" src="../assets/n5.jpg" alt="" />
          </a>
          <div class="p-5">
            <a href="#">
              <h6 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
        ...
        <div class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 px-4">
          <a href="#">
            <img class="rounded-t-lg" src="../assets/n6.jpg" alt="" />
          </a>
          <div class="p-5">
            <a href="#">
              <h6 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
        ...
        <div class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 px-4">
          <a href="#">
            <img class="rounded-t-lg" src="../assets/n7.jpg" alt="" />
          </a>
          <div class="p-5">
            <a href="#">
              <h6 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
        ...
        <div class="max-w-xs bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 px-4">
          <a href="#">
            <img class="rounded-t-lg" src="../assets/n8.jpg" alt="" />
          </a>
          <div class="p-5">
            <a href="#">
              <h6 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">
